...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        try:
            ...
            # Failsafe: if the pages aren't created yet during testing, it won't crash the app
            pass 

        # We use raw HTML for the Data Science link so we can specify target="_self" 
        # to open the external DigitalOcean URL in the SAME tab.
        data_hub_url = "https://killebrew-projects.neuro-edu.io"
        ...
        <div class="presence-bar">
            <a href="https://linkedin.com/" target="_blank" class="presence-icon" title="LinkedIn">
            ...
            <a href="https://scholar.google.com/" target="_blank" class="presence-icon" title="Google Scholar">
