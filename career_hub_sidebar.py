...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        st.page_link("pages/2_mentorship_app.py", label="Tutoring and Career Mentorship", icon=None)
        ...
        <div class="presence-bar">
            <a href="linkedin.com/in/kylewkillebrew" target="_blank" class="presence-icon" title="LinkedIn">
            ...
            <a href="https://twitter.com/jollygreen16" target="_blank" class="presence-icon" title="X (Twitter)">
